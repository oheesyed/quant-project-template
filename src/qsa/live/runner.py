...
async def run_live(config_path: str, dry_run: bool, symbol: str = "DEMO") -> dict[str, Any]:
    ...
    try:
        ...
        equity_proxy = float(account_equity) if account_equity is not None else settings.target_notional
        ...
        return {
            ...
            "delta": round(delta, 4),
            "gross_leverage_estimate": round(_gross_leverage(target_position, last_price, equity_proxy), 6),
