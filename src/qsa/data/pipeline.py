...
async def _fetch_ibkr_history(
    ...
    *,
    ...
    request_contract_id = settings.ib_contract_id if contract_id is None else int(contract_id)
    request_exchange = exchange or settings.ib_exchange
